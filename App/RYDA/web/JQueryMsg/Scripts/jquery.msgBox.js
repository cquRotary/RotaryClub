...
var msgBoxImagePath = "JQueryMsg/Images/";
...
function msg (options) {
    ...
    $(options.buttons).each(function (index, button) {
        buttons += "<input class=\"msgButton\" type=\"button\" name=\"" + button.value + "\" value=\"" + button.value + "\" style=\"width: 50px;\" width=\"50px\" />";
    });
    ...
    function hide() {
        ...
        options.beforeClose();
        divMsgBox.animate({ opacity: 0, "top": top - 50, "left": left }, 50);
    ...
    function getFocus() {
        divMsgBox.fadeOut(200).fadeIn(50);
    }
